                    ...
                    <ul class="flex flex-col gap-4">
                        ...
                        <li>
                            <a href="{{ route('overview') }}" >
                                <div class="flex items-center gap-3 w-full rounded-full border p-[14px_20px] transition-all duration-300  {{ request()->routeIs('overview') ? 'bg-[#662FFF] border-[#8661EE] shadow-[-10px_-6px_10px_0_#7F33FF_inset]' : 'bg-[#070B24] border-[#24283E] shadow-[-10px_-6px_10px_0_#181A35_inset]' }}">
